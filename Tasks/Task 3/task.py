def rich_print_distance_and_calories(
        weight: float = 75,
        height: float = 175,
        steps: int = 8462,
        hours: float = 2,
    ...
    output = f"Сегодня вы прошли {distance} км и затратили {spent_calories} килокалорий. {message}"

    print(output)


rich_print_distance_and_calories()
